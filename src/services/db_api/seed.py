...
def seed_products():
    products = [
        ...
        Products(name="Formaggio Parmigiano", weight="200g", photo="https://parmigianoreggiano.museidelcibo.it/wp-content/uploads/sites/2/2021/05/83.07-A-SCUOLA-DI-CIBO.jpg", description="Parmigiano Reggiano stagionato 24 mesi"),
